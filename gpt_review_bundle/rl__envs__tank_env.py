...
class TankRLEnv:
    ...
    def step(
        ...
        info = {
            ...
            "unsafe_shots": self.game.unsafe_shots_by_tank.get(self.controlled_tank_id, 0),
            "aimed_shots": self.game.good_shots_by_tank.get(self.controlled_tank_id, 0),
            "bad_shots": self.game.bad_shots_by_tank.get(self.controlled_tank_id, 0),

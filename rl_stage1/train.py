...
def parse_args() -> argparse.Namespace:
    """第一关：空场近距离对位。"""
    parser = argparse.ArgumentParser(description="Train stage 1: open map, close facing spawn.")
    ...
    parser.add_argument("--spawn", choices=SPAWNS, default="close_facing", help="坦克出生方式")
    parser.add_argument("--time-limit", type=float, default=30.0, help="每局最多持续的游戏秒数")
    ...
    parser.add_argument("--output", type=Path, default=Path("checkpoints/combat_stage1_open_close"), help="输出目录；断点续训时默认沿用模型所在目录")
